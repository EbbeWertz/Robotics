...
############################################################
###
###     Deze launcher launcht security application
###
############################################################
############################################################
...
def generate_launch_description():
    ...
    security_launcher = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('isfr_bot_security'), 'launch', 'security.launch.py')
        )
    )
